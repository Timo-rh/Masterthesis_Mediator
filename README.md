...
2. **Extend the graph**: The core logic of the application is defined in [graph.py](src/agent/nodes_and_edges.py). You can modify this file to add new nodes, edges, or change the flow of information.
